...
import random
import numpy as np
from build_CRF_inference import CRF_model
random.seed(1)
np.random.seed(1)
import argparse
...
params.outfile = "CRF_infnet_Batchsize"+'_'+str(params.batchsize)+'_dropout_'+ str(params.dropout) + "_LearningRate"+'_'+str(params.eta)+ '_l3_' + str(params.l3)+ '_regutype_' + str(params.regu_type) + '_annealing_'+ str(params.annealing)
