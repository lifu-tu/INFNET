...
import random
import numpy as np
from ADV_CRF_lstm  import GAN_CRF_model
...
params.outfile = "ADV_CRF_LSTM_Batchsize"+'_'+str(params.batchsize)+'_dropout_'+ str(params.dropout) + '_LearningRate_'+str(params.eta)+ '_' + str(params.l2)+ '_'  + str(params.l3)  + '_emb_'+ str(params.emb)
